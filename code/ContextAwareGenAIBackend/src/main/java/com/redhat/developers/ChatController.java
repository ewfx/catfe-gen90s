...
public class ChatController {
    ...
    public ResponseEntity<Resource> downloadReport() throws IOException {
        String reportPath = "C:/Users/kprag/Downloads/spring-boot-configmaps-demo-master/spring-boot-configmaps-demo-master/target/cucumber-reports/report.html"; // Ensure the path is correct
